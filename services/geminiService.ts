...
const getPrompts = (clothing: ClothingOption, background: BackgroundOption) => {
  ...
  switch (clothing) {
    ...
    case ClothingOption.MensKimono:
      clothingPrompt = "a formal black Japanese Mofuku kimono (mourning kimono). Texture: Completely solid black plain silk (Muji), NO woven patterns, NO embroidery. Obi is solid black plain (Kuro-tomo-obi) with NO patterns or designs. Masculine, dignified structure.";
      break;
